...
// MARK: - Mock Theme
//
// Decoupled copy of DevLingo's AppColors constants (dark theme, dev/education focused).
// Keep RGB values in sync with /DevLingo/Core/Theme/AppColors.swift
...
enum MockTheme {
    ...
    static let accent = Color(hex: "FF9F0A")     // Orange - streak

    // MARK: - Difficulty
    static let easy = Color(hex: "30D158")
    static let medium = Color(hex: "FF9F0A")
    static let hard = Color(hex: "FF453A")

    // MARK: - Category Colors (matching real app)
